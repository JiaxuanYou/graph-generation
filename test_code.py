...
#
#
# graph_list = load_graph_list(fname,is_real=False)
# graph_list = [graph_list[i] for i in range(len(graph_list)) if graph_list[i].number_of_nodes()>60]
#
...
# #     print(graph_list[i].number_of_nodes(),graph_list[i].number_of_edges())
#
#
#
# # graph_list = []
...
# #     for j in range(6, 11):
# #         for k in range(20):
# #             graph_list.append(caveman_special(i, j, p_edge=0.5)) # default 0.8
#
# # for i in range(4):
# #     draw_graph_list(graph_list[256*i:min(256*(i+1),len(graph_list))],row=16,col=16,fname='figures/graph_completion'+str(sample_time)+'_'+str(i))
#
#
# graph_list = []
# for i in range(2, 3):
...
#         for k in range(10):
#             graph_list.append(caveman_special(i,j, p_edge=0.3))
#
# shuffle(graph_list)
# draw_graph_list(graph_list[0:16],row=4,col=4,fname='figures/graph_completion_real'+str(sample_time))
#
...
# graph_test_len = [g.number_of_nodes() for g in graphs_test]
# graph_train_len = [g.number_of_nodes() for g in graphs_train]
# print(graph_test_len)
# print(graph_train_len)