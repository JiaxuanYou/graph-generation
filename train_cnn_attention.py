...
def train_epoch(epoch, args, encoder, decoder, data_loader, optimizer, scheduler):
    ...
    for batch_idx, data in enumerate(data_loader):
        ...
        #     make_graph(node_idx[0], [real_hop1.dataset, real_hop2.dataset, real_hop3.dataset] , max_degree = 9, key='real')
        #     print('node_idx[0]', node_idx[0],'pred')
        #     make_graph(node_idx[0], [pred_hop1.dataset, pred_hop2.dataset, pred_hop3.dataset] , max_degree = 9, key='pred')
